...
_CONTENT_ALTERNATE_GROUPS = [
    ...
    ["MegChat02", "MegChat02_Alt"],
    ["MegChat03", "MegChat03_Alt"],
    ...
    ["TheseusMiscStart23_A", "TheseusMiscStart23_B"],
    ["TheseusMiscStart24_A", "TheseusMiscStart24_B"],
    ["TheseusMiscStart25_A", "TheseusMiscStart25_B"],
    ["TheseusMiscStart26_A", "TheseusMiscStart26_B"],
    ["TheseusSecondEncounter01_IfYouLost", "TheseusSecondEncounter01_IfYouWon"],
    # Hades 2
    ["DemeterPalacePostTrueEnding01", "DemeterPalacePostTrueEnding01_B"],
    ["ErisAboutRelationship02", "ErisBossAboutRelationship02"],
    ["HecateAboutBountyBoard01", "HecateBossAboutPackagedBounties01", "HecateBossAboutPackagedBounties01_B"],
