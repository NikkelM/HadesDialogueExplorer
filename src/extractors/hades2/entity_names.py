...
HADES2_ENTITY_NAMES = {
    ...
    "Codex_AthenaUnlockHint01": "may be interested in an offering of  but only on Olympus.",
    "Codex_DoesntWantGiftHint": "Now seems not the time to offer gifts to .",
    "Codex_DoraNotInMain": "is not inclined to accept  all the way over here in the Training Grounds.",
    "Codex_DoraNotInTent": "is not inclined to accept  outside the comfort of your tent.",
    "Codex_TimePassesGiftUsed": "There is not time enough this night to invite  for an outing.",
