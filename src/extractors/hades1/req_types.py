...
HADES1_REQ_TYPE_LABELS = {
    ...
    "RequiredFalseQueuedTextLines":   "Must NOT be queued (ANY)",
    "RequiredFalseTextLinesThisRun":  "Must NOT have played (ANY, this run)",
    "RequiredFalseTextLinesLastRun": "Must NOT have played (ANY, last run)",
    "RequiredFalseTextLinesThisRoom": "Must NOT have played (ANY, this room)",
