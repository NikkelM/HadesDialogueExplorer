...
def extract_enemy_data(parsed: dict, source_label: str = "", source_file: str = "", game_data_lists: dict | None = None, offer_text_map: dict | None = None, preset_choices: dict | None = None) -> dict:
    result = {}
